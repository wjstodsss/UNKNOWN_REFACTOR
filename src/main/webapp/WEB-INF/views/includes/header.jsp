	...
	<div class="wrapper">
		<div class="wrap">
			...
			<div class="top_area">
				...
				<div id="icon">
					<div class="upicon1">
						<a href="/manboki" id="manboki-icon"> <img
					...
					<div class="upicon1">
						<a href="/cart/${member.memberId}" id="cart-icon"> <img
			...
			<div class="navi_bar_area">
				<div class="category_wrap">
					<img src="/resources/img/ico_gnb_all.png"><a href="#"
						class="category_btn"><span>카테고리</span></a>
					<div class="menu-1">
						<ul>
							<li><a class="submenu1" href="/product/newArr"><img
									src="/resources/img/new.png"><span
									style="display: block;">신상품</span></a>
								<ul>
									<li><a href="/product/list?cateRange=1000-1099">전체</a></li>
								</ul></li>
							<li><a class="submenu2"
								href="/product/list?cateRange=1101-1115"><img
									src="/resources/img/chicken_breast.png"><span
									style="display: block;">닭가슴살</span></a>
								<ul>
							...
							<li><a class="submenu3"
								href="/product/list?cateRange=1201-1209"><img
									src="/resources/img/lunchbox.png"><span
									style="display: block;">도시락·볶음밥</span></a>
								<ul>
							...
							<li><a class="submenu4"
								href="/product/list?cateRange=1301-1308"><img
									src="/resources/img/drink.png"><span
									style="display: block;">음료·차·프로틴</span></a>
								<ul>
							...
							<li><a class="submenu5"
								href="/product/list?cateRange=1401-1411"><img
									src="/resources/img/instant.png"><span
									style="display: block;">즉석 간편식</span></a>
								<ul>
							...
							<li><a class="submenu6"
								href="/product/list?cateRange=1501-1503"><img
									src="/resources/img/beef.png"><span
									style="display: block;">소고기</span></a>
								<ul>
							...
							<li><a class="submenu7"
								href="/product/list?cateRange=1601-1603"><img
									src="/resources/img/sweetpotato.png"><span
									style="display: block;">견과·고구마·감자</span></a>
								<ul>
							...
							<li><a class="submenu8"
								href="/product/list?cateRange=1701-1704"><img
									src="/resources/img/salad.png"><span
									style="display: block;">샐러드·과일</span></a>
								<ul>
							...
							<li><a class="submenu9"
								href="/product/list?cateRange=1801-1804"><img
									src="/resources/img/eggs.png"><span
									style="display: block;">계란·난백·콩</span></a>
								<ul>
							...
							<li><a class="submenu10"
								href="/product/list?cateRange=1901-1902"><img
									src="/resources/img/fillet.png"><span
									style="display: block;">닭안심살</span></a>
								<ul>
							...
							<li><a class="submenu11"
								href="/product/list?cateRange=2001-2007"><img
									src="/resources/img/cookie.png"><span
									style="display: block;">과자·간식·떡</span></a>
								<ul>
				...
				<nav id="gnb" class="gnb">
					<ul>
						...
						<li><a
							href="${pageContext.request.contextPath}/product/promotion"><span>이달의
									특가</span></a></li>
						<li><a
							href="${pageContext.request.contextPath}/product/brand"><span>브랜드관</span></a></li>
						<li><a
							href="${pageContext.request.contextPath}/product/timesale"><span>888데이</span></a></li>
						...
						<li><a
							href="${pageContext.request.contextPath}/expressDelivery"><img
								src="/resources/img/delivery.png" name="특급배송"></a></li>
					</ul>
				</nav>
			</div>
		</div>
