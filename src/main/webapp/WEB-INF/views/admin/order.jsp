...
<%@include file="includes/common-cri.jsp"%>
		                    ...
		                    <tr>
		                        	...
		                        	<div class="custom-sort-component">
						                ...
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/order' data-sortColumn='orderId'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
		                        ...
		                        <th>
		                        	<div class="custom-sort-component">
						                ...
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/order' data-sortColumn='receiver'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/order' data-sortColumn='receiver'
		                        ...
		                        <th>
		                        	<div class="custom-sort-component">
						                ...
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/order' data-sortColumn='memberId'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/order' data-sortColumn='memberId'
		                        ...
		                        <th>
		                        	<div class="custom-sort-component">
						                ...
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/order' data-sortColumn='orderState'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/order' data-sortColumn='orderState'
		                        ...
		                        <th>
		                        	<div class="custom-sort-component">
						                <div class="label">주문일</div>
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/order' data-sortColumn='orderDate'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/order' data-sortColumn='orderDate'
	...
	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	        <div class="modal-header row custom-modal-header-row">
	                <div class="col-lg-6">
	                    <h5 class="modal-orderName custom-modal-header-title">order 등록</h5>
	                </div>
	                <div class="col-lg-6">
	             ...
	             <form id="registerForm" name="registerForm" role="form" action="register" method="post">
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="text" class="form-control" name="memberId" placeholder="회원ID 입력하세요" required>
                      	<div class="btn btn-dark my-2" onclick="checkMemberId()">
	                    	<span>회원ID 확인</span>
	                	</div> 
	                </div>
	...
	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	        <div class="modal-header row custom-modal-header-row">
	                <div class="col-lg-6">
	                    <h5 class="modal-orderName custom-modal-header-title">order 수정</h5>
	                </div>
	                <div class="col-lg-6">
	                    <button type="button" class="close" aria-label="Close"
	                            onclick="closeModal(this)">
