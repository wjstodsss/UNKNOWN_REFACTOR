		            ...
		            <div class="row">
		                <div class="col-lg-12">
		                    <form id='searchForm' action="/admin/brand/list" method='get' class='searchForm'>
		                        ...
		                        <a href="/admin/brand/list" type="button"
		            ...
		            <table class="table table-breviewed able-hover  custom-table">
		                ...
		                <tr>
		                    <th class="col-lg-1">
		                        <div class="custom-sort-component">
		                            <div class="label">브랜드ID</div>
		                            <div class="sort-icons">
		                                <a href="#" class="no-anchor-text-decoration"
		                                   data-groupColumn='/brand' data-sortColumn='brandId'
		                                   data-sortType='asc'>▲</a>
		                                <a href="#"
		                    ...
		                    <th class="col-lg-1">
		                        <div class="custom-sort-component">
		                            ...
		                            <div class="sort-icons">
		                                <a href="#" class="no-anchor-text-decoration"
		                                   data-groupColumn='/brand' data-sortColumn='brandName'
		                                   data-sortType='asc'>▲</a>
		                                <a href="#"
		                                   class="no-anchor-text-decoration"
		                                   data-groupColumn='/brand' data-sortColumn='brandName'
		                    ...
		                    <th class="col-lg-2">
		                        <div class="custom-sort-component">
		                            ...
		                            <div class="sort-icons">
		                                <a href="#" class="no-anchor-text-decoration"
		                                   data-groupColumn='/brand' data-sortColumn='regDate'
		                                   data-sortType='asc'>▲</a>
		                                <a href="#"
		                                   class="no-anchor-text-decoration"
		                                   data-groupColumn='/brand' data-sortColumn='regDate'
		                    ...
		                    <th class="col-lg-2">
		                        <div class="custom-sort-component">
		                            ...
		                            <div class="sort-icons">
		                                <a href="#" class="no-anchor-text-decoration"
		                                   data-groupColumn='/brand' data-sortColumn='updateDate'
		                                   data-sortType='asc'>▲</a>
		                                <a href="#"
		                                   class="no-anchor-text-decoration"
		                                   data-groupColumn='/brand' data-sortColumn='updateDate'
		                ...
		                <c:forEach var="brand" items="${brands}" varStatus="status">
		                    ...
		                    <tr class="odd gradeX">
		                        ...
		                        <td><fmt:formatDate pattern="yyyy-MM-dd" value="${brand.regDate != null ? brand.regDate : '기본'}" /></td>
		                        <td><fmt:formatDate pattern="yyyy-MM-dd" value="${brand.updateDate != null ? brand.updateDate : '수정 전'}" /></td>
		                    </tr>
		                </c:forEach>
		                </tbody>
		            </table>
	    ...
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
	            <div class="modal-header row custom-modal-header-row">
	                <div class="col-lg-6">
	                    <h5 class="modal-itemName custom-modal-header-title">브랜드 등록</h5>
	                </div>
	                <div class="col-lg-6">
	...
	<div class="modal" id="formModal2" tabindex="-1" role="dialog"
	    ...
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
	            <div class="modal-header row custom-modal-header-row">
	                <div class="col-lg-6">
	                    <h5 class="modal-itemName custom-modal-header-title">브랜드 수정</h5>
	                </div>
	                <div class="col-lg-6">
	                    <button type="button" class="close" aria-label="Close"
	                            onclick="closeModal(this)">
