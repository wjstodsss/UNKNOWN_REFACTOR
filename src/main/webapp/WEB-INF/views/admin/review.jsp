				    ...
				    <div class="col-lg-12">                    
				        <form id='searchForm' action="/admin/review/list" method='get' class='searchForm'>
				            ...
				            <button class='btn custom-keyword-btn'>Search</button>
                       		<a href="/admin/review/list" type="button"
						...
						<tr>
								...
								<div class="custom-sort-component">
					                ...
					                <div class="sort-icons">
					                    <a href="#" class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='reviewId'
					                       data-sortType='asc'>▲</a>
					                    <a href="#"
							...
							<th>
								<div class="custom-sort-component">
					                ...
					                <div class="sort-icons">
					                    <a href="#" class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='itemId'
					                       data-sortType='asc'>▲</a>
					                    <a href="#"
					                       class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='itemId'
                            ...
                            <th>
                            	<div class="custom-sort-component">
					                ...
					                <div class="sort-icons">
					                    <a href="#" class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='reviewTitle'
					                       data-sortType='asc'>▲</a>
					                    <a href="#"
					                       class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='reviewTitle'
                            ...
                            <th>
                            	<div class="custom-sort-component">
					                ...
					                <div class="sort-icons">
					                    <a href="#" class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='reviewWriter'
					                       data-sortType='asc'>▲</a>
					                    <a href="#"
					                       class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='reviewWriter'
                            ...
                            <th>
                            	<div class="custom-sort-component">
					                ...
					                <div class="sort-icons">
					                    <a href="#" class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='reviewRegdate'
					                       data-sortType='asc'>▲</a>
					                    <a href="#"
					                       class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='reviewRegdate'
                            ...
                            <th>
                            	<div class="custom-sort-component">
					                ...
					                <div class="sort-icons">
					                    <a href="#" class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='answer'
					                       data-sortType='asc'>▲</a>
					                    <a href="#"
					                       class="no-anchor-text-decoration"
					                       data-groupColumn='/review' data-sortColumn='answer'
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header row custom-modal-header-row">
	                <div class="col-lg-6">
	                    <h5 class="modal-reviewName custom-modal-header-title">review 등록</h5>
	                </div>
	                <div class="col-lg-6">
	...
	<div class="modal" id="formModal2" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header row custom-modal-header-row">
	                <div class="col-lg-6">
	                    <h5 class="modal-reviewName custom-modal-header-title">review 수정</h5>
	                </div>
	                <div class="col-lg-6">
	                    <button type="button" class="close" aria-label="Close"
	                            onclick="closeModal(this)">
