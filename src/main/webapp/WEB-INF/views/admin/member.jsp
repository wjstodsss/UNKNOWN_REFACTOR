					  ...
					  <div class="row">       
					    <div class="col-lg-4">                    
					        <form id='searchForm' action="/admin/member/list" method='get' class='searchForm'>
	                        	...
	                        	<a href="/admin/member/list" type="button" class="btn custom-keyword-btn mx-2">검색해제</a>
					        </form>
					    </div>
					</div>
					<!-- end 검색조건 -->
							...
							<tr>
									...
									<div class="custom-sort-component">
						                ...
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='memberId'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
								...
								<th>
									<div class="custom-sort-component">
						                ...
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='memberName'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='memberName'
	                            ...
	                            <th>
	                            	<div class="custom-sort-component">
	                            		<div class="label">메일주소</div>
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='memberMail'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='memberMail'
	                            ...
	                            <th>
	                            	<div class="custom-sort-component">
						                ...
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='regDate'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='regDate'
	                            ...
	                            <th>
	                            	<div class="custom-sort-component">
						                ...
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='memberPhone'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='memberPhone'
	                            ...
	                            <th>
	                            	<div class="custom-sort-component">
						                ...
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='adminCk'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='adminCk'
	                            ...
	                            <th>
	                            	<div class="custom-sort-component">
	                            		<div class="label">휴면여부</div>
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='suspended'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='suspended'
	                            ...
	                            <th>
	                            	<div class="custom-sort-component">
	                            		<div class="label">탈퇴여부</div>
						                <div class="sort-icons">
						                    <a href="#" class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='withdrawal'
						                       data-sortType='asc'>▲</a>
						                    <a href="#"
						                       class="no-anchor-text-decoration"
						                       data-groupColumn='/member' data-sortColumn='withdrawal'
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header row custom-modal-header-row">
	                <div class="col-lg-6">
	                    <h5 class="modal-memberName custom-modal-header-title">member 등록</h5>
	                </div>
	                <div class="col-lg-6">
	...
	<div class="modal" id="formModal2" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header row custom-modal-header-row">
	                <div class="col-lg-6">
	                    <h5 class="modal-memberName custom-modal-header-title">member 수정</h5>
	                </div>
	                <div class="col-lg-6">
	                    <button type="button" class="close" aria-label="Close"
	                            onclick="closeModal(this)">
